...
static void ShowDemoWindowWidgets()
{
	...
	if( ImGui::TreeNode( "Data Types" ) )
	{
		...
		ImGui::DragScalar( "drag float ^2",  ImGuiDataType_Float,  &f32_v, 0.005f,  &f32_zero, &f32_one, "%f", ImGuiSliderFlags_Logarithmic );
		ImGui::SameLine();
...
void ImTui::ShowAboutWindow( bool* p_open )
{
	...
	if( show_config_info )
	{
		...
		{
			ImGui::Text( "io.ConfigWindowsMemoryCompactTimer = %.1ff", io.ConfigMemoryCompactTimer );
		}
...
static void ShowExampleAppConstrainedResize( bool* p_open )
{
	...
	if( ImGui::Begin( "Example: Constrained Resize", p_open, flags ) )
	{
		...
		if( ImGui::Button( "20x10" ) )
		{
			ImGui::SetWindowSize( ImVec2( 20, 10 ) );
		}
		ImGui::SameLine();
		if( ImGui::Button( "50x25" ) )
		{
			ImGui::SetWindowSize( ImVec2( 50, 25 ) );
		}
		ImGui::SameLine();
		if( ImGui::Button( "80x20" ) )
		{
			ImGui::SetWindowSize( ImVec2( 80, 20 ) );
		}
